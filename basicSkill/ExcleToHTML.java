...
public class ExcleToHTML{
	/**
	 * 简单的excle导出为HTML
	 */
	public static void main(String[] args) {
		try {
			ExcleToHTML poire = new ExcleToHTML();

			String path = "D://test.xls";
			String html = "D://test.html";
			...
			byte[] a = poire.getExcelInfo(wb).getBytes();
	...
	public String getExcelInfo(HSSFWorkbook wb) throws Exception {
		...
		sb.append("<table border='1' cellspacing='1' width='100%'>");
		HSSFRow row = null;
		HSSFCell cell = null;
